...
<body>
  ...
  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
         <a class="dropdown-item" href="<?php echo base_url().'admin/karyawan_harian'; ?>"><i class="fa fa-hand-paper-o "></i> Rekap Absensi Harian</a> 
          <a class="dropdown-item" href="<?php echo base_url().'admin/karyawan_event'; ?>"><i class="fa fa-list-alt"></i> Rekap Absensi Event</a>
  </li> 
         ...
         <a class="dropdown-item" href="<?php echo base_url().'admin/absen_isi'; ?>"><i class="fa fa-hand-paper-o "></i> Absensi </a> 
          <a class="dropdown-item" href="<?php echo base_url().'admin/absen_laporan'; ?>"><i class="fa fa-list-alt"></i> Rekap Absensi </a>
                  <a class="dropdown-item" href="<?php echo base_url().'admin/absen_persiswa_laporan'; ?>"><i class="fa fa-child"></i> Rekap Absensi Persiswa</a>
									<a class="dropdown-item" href="<?php echo base_url().'admin/download_absen'; ?>"><i class="fa fa-download"></i> Download Absensi Manual</a>
...
<!-- </li> -->
        ...
        <span class="navbar-text mr-3 text-center">
          Halo, <?php echo $this->session->userdata('username'); ?> <br>[ Admin ]
        </span>
