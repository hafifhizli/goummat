...
//            $this->Line(10,$this->GetY(),200,$this->GetY());
			...
			$this->cell(30,10,'GAMPONG',1,0,'C',1);
			$this->cell(30,10,'KECAMATAN',1,0,'C',1);
			$this->cell(30,10,'KABUPATEN',1,0,'C',1);
			$this->cell(24,10,'JABATAN',1,0,'C',1);
			$this->cell(33,10,'STATUS',1,1,'C',1);


        }
    }

    function Content($karyawan,$tahun,$bulan,$hari){
        $ya = 46;
        $rw = 6;
        $no = 1;
        ...
        $this->setFont('Arial','B',9);
        $this->setFillColor(255,255,255);
		$this->cell(20,10,'Hari : ',0,0,'C',1);
        $this->cell(15,10,$hari,0,0,'C',1);
        ...
        foreach ($karyawan as $key) {
            ...
            $this->cell(30,10,$key->gampong,1,0,'C',1);
			$this->cell(30,10,$key->kecamatan,1,0,'C',1);
            $this->cell(30,10,'Bireun',1,0,'C',1);
			$this->cell(24,10,$key->jabatan,1,0,'C',1);
			if($key->id_status == "1"){
				$this->cell(33,10,"Hadir",1,1,'C',1);
			}elseif($key->id_status == "2"){
				$this->cell(33,10,"Telat",1,1,'C',1);
			}elseif($key->id_status == "3"){
				$this->cell(33,10,"Izin",1,1,'C',1);
			}elseif($key->id_status == "4"){
				$this->cell(33,10,"Sakit",1,1,'C',1);
			}elseif($key->id_status == "5"){
				$this->cell(33,10,"Alpha",1,1,'C',1);
			}
...
$pdf->Content($karyawan,$tahun,$bulan,$hari);
$pdf->Output();
